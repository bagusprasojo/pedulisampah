...
<div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="/img/river.jpg" alt="..." /></div>
                <div class="col-lg-5">
                    ...
                    <a class="btn btn-primary" href="/trash-reports">Laporkan Sampah!</a>
                </div>
            </div>
            <!-- Call to Action-->
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer"><a class="btn btn-primary btn-sm" href="/tambah-laporan">Laporkan</a></div>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer"><a class="btn btn-primary btn-sm" href="/trash-reports">Share !</a></div>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer"><a class="btn btn-primary btn-sm" href="/komunitas">Join</a></div>
                    </div>
                </div>
            </div>
        </div>
